...
public class UsersDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String alias) throws UsernameNotFoundException {
		 Usuario usuario = usuarioService.findByAlias(alias);
	        ...
	        return userBuilder(usuario.getAlias(),passwordEncoder.encode(usuario.getClave()),usuario.getRoleId().getNombre());
	}
	...
	private User userBuilder(String alias, String password, String... roles){
        ...
        return new User(alias, password, enabled, accountNonExpired, credentialsNonExpired, accountNotLocked, authorities);
    }
